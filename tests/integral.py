...
class AlgebraicEquivalence(unittest.TestCase):
    ...
    def test_integral(self):
        ...
        nodes_num = 2
        bins_num = 2
        # x0 = 0.0*torch.eye(nodes_num) #utils.mean_normalization(torch.rand(size=(nodes_num, dim)))
        ...
        print("bounds", bm.get_bins_bounds())
        tl = 0.0 #+ utils.EPS
        tr = 0.5 #- + utils.EPS
        ...
        print(riemann_integral_sum_lower_bound, riemann_integral_sum_upper_bound)
